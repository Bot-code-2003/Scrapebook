        ...
        <section className="mb-20">
          ...
          <div className="prose prose-gray">
            <p className="text-gray-600 leading-relaxed mb-4">
              hi! i'm a 22 year old AI/ML Engineer who's already a bit fed up with corporate life. 😅
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
              but here's what keeps me going — i absolutely love building cute little passion 
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ...
              idea — what if you could make a digital gift that actually feels like a gift? 
